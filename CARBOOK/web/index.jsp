    				...
    				<div class="row no-gutters">
		          		...
		          		<h2>Tìm kiếm xe</h2>
			    			<div class="form-group">
			    				...
			    				<input type="text" name="pickupLocation" class="form-control" placeholder="Thành phố, Sân bay...">
			    			</div>
			    			<div class="form-group">
			    				<label for="" class="label">Địa điểm trả xe</label>
			    				<input type="text" name="dropoffLocation" class="form-control" placeholder="Thành phố, Sân bay...">
			    			</div>
			    			<div class="d-flex">
    ...
    <section class="ftco-counter ftco-section img bg-light" id="section-counter">
    	...
    	<div class="container">
          ...
          <div class="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
            <div class="block-18">
              <div class="text text-border d-flex align-items-center">
                <strong class="number" data-number="${totalCars}">${totalCars}</strong>
